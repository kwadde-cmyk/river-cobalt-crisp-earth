...
- **StartOS 0.4** — SDK-Wrapper in `deploy/startos`, Version **0.1.4**, Sideload der `.s9pk`
...
Wrapper: `deploy/startos` (`@start9labs/start-sdk` 2.0.9). Paket-Version **0.1.4** (`deploy/startos/package.json` und `deploy/startos/startos/versions/current.ts`).
