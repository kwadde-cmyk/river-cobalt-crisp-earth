...
const de: Record<string, string> = {
  ...
  "node.bridge.help": "1. Node-Tab öffnen — die Zeile „JSONRPC server handles only POST requests“ ist normal. 2. Lesezeichen »Scriptwerk-Brücke« in die Lesezeichenleiste ziehen und IM Node-Tab anklicken. Alternativ das Skript kopieren und in der Konsole (F12) des Node-Tabs einfügen.",
  "node.bridge.on": "Brücke aktiv — RPC läuft per POST über den Node-Tab.",
  "node.bridge.openTab": "Node-Tab öffnen",
  "node.bridge.bookmark": "Scriptwerk-Brücke",
  "node.bridge.drag": "Auf die Lesezeichenleiste ziehen, dann im Node-Tab anklicken — nicht hier.",
  ...
  "node.bridge.copied": "Skript kopiert. Im Node-Tab: F12 → Konsole → einfügen → Enter.",
...
const en: Record<string, string> = {
  ...
  "node.bridge.help": "1. Open the node tab — the line “JSONRPC server handles only POST requests” is expected. 2. Drag the »Scriptwerk bridge« bookmark to the bookmarks bar and click it ON the node tab. Or copy the script and paste it into that tab’s console (F12).",
  "node.bridge.on": "Bridge active — RPC runs via POST through the node tab.",
  "node.bridge.openTab": "Open node tab",
  "node.bridge.bookmark": "Scriptwerk bridge",
  "node.bridge.drag": "Drag to the bookmarks bar, then click it on the node tab — not here.",
  ...
  "node.bridge.copied": "Script copied. On the node tab: F12 → Console → paste → Enter.",
