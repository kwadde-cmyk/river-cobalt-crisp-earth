...
const de: Record<string, string> = {
  ...
  "node.lockOff": "Frei",
  "node.lockHint": "Zugangsdaten kommen von StartOS. Entsperren nur, um eine andere Node einzutragen.",
...
const en: Record<string, string> = {
  ...
  "node.lockOn": "Locked",
  "node.lockOff": "Open",
  "node.lockHint": "Credentials come from StartOS. Unlock only to point at a different node.",
