...
const de: Record<string, string> = {
  ...
  "keys.reuseHint": "Aus: ein Fingerprint = ein Signing-Slot, Childkeys A1, A2 … importieren.\nAn: derselbe xpub mit hochzählender Ableitung in mehreren Stufen.",
  ...
  "keys.reuseOnNeed": "Reuse an: dieselbe xpub, Ableitung zählt hoch — /<0;1>/*, /<2;3>/*, /<4;5>/* (wie Liana).",
  ...
  "node.startos.help": "StartOS: Bitcoin Core in den Dienste-Abhängigkeiten einschalten. RPC-Nutzer scriptwerk wird angelegt, Verbindung läuft über den Server — ohne Brücke. Remote-Node: Adresse und eigene Zugangsdaten wie bisher.",
  ...
  "node.presetStartos": "StartOS: Bitcoin Core voreingestellt, Nutzer {user}. Passwort kommt vom Server, nicht aus dem Formular.",
...
const en: Record<string, string> = {
  ...
  "node.startos.help": "StartOS: enable Bitcoin Core on the service dependencies. RPC user scriptwerk is created; the studio talks through the server — no bridge. Remote node: address and credentials as before.",
  ...
  "node.presetStartos": "StartOS: Bitcoin Core preconfigured, user {user}. Password comes from the server, not this form.",
