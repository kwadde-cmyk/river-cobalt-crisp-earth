...
const de: Record<string, string> = {
  ...
  "read.ordersHint": "Bei multi() ändert die Pubkey-Reihenfolge Script, Adresse und Checksumme. Jede Variante gibt es als /<0;1>/* und /0/*. Antippen übernimmt sie.",
...
const en: Record<string, string> = {
  ...
  "read.ordersHint": "With multi(), pubkey order changes script, address, and checksum. Each variant is listed as /<0;1>/* and /0/*. Tap a row to apply it.",
