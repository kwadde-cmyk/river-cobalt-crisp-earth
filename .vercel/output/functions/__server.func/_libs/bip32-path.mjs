...
//#region node_modules/bip32-path/index.js
var require_bip32_path = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	BIPPath.prototype.toString = function(noRoot, oldStyle) {
		...
		for (var i = 0; i < this.path.length; i++) {
			var tmp = this.path[i];
			if (tmp & HARDENED) ret[i] = (tmp & 2147483647) + (oldStyle ? "h" : "'");
			else ret[i] = tmp;
		}
...
//#endregion
export { require_bip32_path as t };
